...
#define STARTUPS_Version_CTL0 	                        0x00000010
#define STARTUPS_Version_CTL1 	                        0x00000014
#define STARTUPS_Version_CTL2 	                        0x00000018
#define STARTUPS_Version_CTL3 	                        0x0000001C
...
{   
    uint32_t ver_ctrl0 = 0;
    uint32_t ver_ctrl1 = 0;
    uint32_t ver_ctrl2 = 0;
    uint32_t ver_ctrl3 = 0;
    ...
    ver_ctrl0 = FMC_Read(STARTUPS_Version_CTL0);
    ver_ctrl1 = FMC_Read(STARTUPS_Version_CTL1);
    ver_ctrl2 = FMC_Read(STARTUPS_Version_CTL2);
    ver_ctrl3 = FMC_Read(STARTUPS_Version_CTL3);

    printf("ver read: 0x%8X\r\n", ver_ctrl0);
    printf("ver read: 0x%8X\r\n", ver_ctrl1);
    printf("ver read: 0x%8X\r\n", ver_ctrl2);
    printf("ver read: 0x%8X\r\n", ver_ctrl3);
